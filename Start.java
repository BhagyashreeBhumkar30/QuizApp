...
public class Start extends JFrame  implements ActionListener{
	...
	{   this.name=name;
        ...
        image.setBounds(0,0, 1300, 392);
         ...
         qno=new JLabel();
        qno.setBounds(100,450,1000,30);
        qno.setFont(new Font("Tahona",Font.PLAIN,30));
        add(qno);

         question=new JLabel();
        question.setBounds(150,450,1100,30);
        question.setFont(new Font("Tahona",Font.PLAIN,30));
        add(question);
        ...
        answers[9][1] = "Bytecode is executed by JVM";
          ...
          opt3.setBounds(170, 590, 700, 30);
          opt3.setFont(new Font("Dailog",Font.PLAIN,20));
          opt3.setBackground(Color.WHITE);
          add(opt3);
          
           opt4=new JRadioButton();
          opt4.setBounds(170, 630, 700, 30);
          ...
          next.setFont(new Font("Dailog",Font.PLAIN,22));
          ...
          lifeline.setFont(new Font("Dailog",Font.PLAIN,22));
          ...
          Submit.setFont(new Font("Dailog",Font.PLAIN,22));
	...
	public void paint(Graphics g)
	{
		...
		g.setFont(new Font("Dilog",Font.PLAIN,20));
		if (timer >0)
		{
